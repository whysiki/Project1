...
class  Comment:
    def __init__(self,root,isTKroot = True,params=None):
        ...
        self.UIJsonString = '{"Version": "1.0.0", "UIName": "Comment", "Description": "", "WindowSize": [960, 640], "WindowPosition": "Center", "WindowHide": false, "WindowResizable": true, "WindowTitle": "电影评论", "DarkMode": false, "BorderWidth": 0, "BorderColor": "#ffffff", "DropTitle": false, "DragWindow": true, "MinSize": [0, 0], "TransparentColor": null, "RootTransparency": 255, "ICOFile": null, "WinState": 1, "WinTopMost": true, "BGColor": "#EFEFEF", "GroupList": {}, "WidgetList": [{"Type": "Form", "Index": 1, "AliasName": "Form_1", "BGColor": "#EFEFEF", "Size": [960, 640], "EventList": {"Load": "Form_1_onLoad"}}, {"Type": "ListBox", "Index": 2, "AliasName": "ListBox_1", "ParentName": "Form_1", "PlaceInfo": [0, 0.0015625, 961, 638, "nw", true, false], "Visible": true, "Size": [961, 638], "ExportSelection": 1, "BGColor": "#FFFFFF", "SelectMode": "BROWSE", "EventList": {"MouseWheel": "ListBox_1_onMouseWheel"}, "ScrollBarList": [false, true]}]}'
